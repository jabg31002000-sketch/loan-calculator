    ...
    <div className="min-h-screen bg-[#F6F1EB]">
      <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-[#5E6E73]">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-3xl border border-[#E5E1DA] bg-white p-6 shadow-md sm:p-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#10353F]/5">
                <Mail className="h-5 w-5 text-[#10353F]" />
              </div>
              <h2 className="text-base font-bold text-[#0E2A3A]">이메일 문의</h2>
            </div>
            <p className="mb-4 text-sm leading-6 text-[#5E6E73]">
              아래 이메일로 문의 내용을 보내주시면 확인 후 답변 드리겠습니다.
            </p>
            <a
              href={MAILTO_BASE}
              className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#10353F]/15 bg-[#10353F]/5 px-4 py-3 text-sm font-semibold text-[#10353F] transition hover:border-[#10353F]/20 hover:bg-[#10353F]/10 hover:text-[#10353F] active:scale-[0.98]"
            >
          ...
          <div className="rounded-3xl border border-[#E5E1DA] bg-white p-6 shadow-md sm:p-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F6F1EB]">
                <Clock className="h-5 w-5 text-[#5E6E73]" />
              </div>
              <h2 className="text-base font-bold text-[#0E2A3A]">응답 안내</h2>
            </div>
            <ul className="space-y-2 text-sm leading-7 text-[#5E6E73]">
          ...
          {/* 대출 금리 비교 CTA */}
          <div className="rounded-3xl border border-[#E5E1DA] bg-[#10353F]/5 p-6 shadow-md sm:p-8">
            <p className="mb-1 text-xs font-semibold uppercase tracking-wide text-[#10353F]/70">
              지금 바로 확인하세요
            </p>
            <h2 className="mb-1 text-base font-bold text-[#0E2A3A]">
              더 낮은 금리로 갈아탈 수 있을까요?
            </h2>
            <p className="mb-4 text-sm leading-6 text-[#5E6E73]">
          ...
          <div className="rounded-3xl border border-[#E5E1DA] bg-white p-6 shadow-md sm:p-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#10353F]/5">
                <MessageSquare className="h-5 w-5 text-[#10353F]" />
              </div>
              <h2 className="text-base font-bold text-[#0E2A3A]">문의 유형</h2>
            </div>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {INQUIRY_TYPES.map((item) => (
                <a
                  ...
                  className="rounded-xl bg-[#F6F1EB] p-4 transition hover:bg-[#E5E1DA] active:scale-[0.98]"
                >
                  <p className="text-sm font-semibold text-[#0E2A3A]">{item.label}</p>
                  <p className="mt-0.5 text-xs text-[#5E6E73]">{item.desc}</p>
                </a>
              ))}
            </div>
          </div>
          ...
          {/* 면책 안내 */}
          <div className="rounded-2xl bg-[#F6F1EB] px-4 py-4 text-sm leading-6 text-[#5E6E73]">
