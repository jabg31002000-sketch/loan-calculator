  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex h-8 w-full overflow-hidden rounded-full">
        <div className="flex items-center justify-center bg-emerald-500 text-xs font-bold text-white" style={{ width: `${Math.max(loanPercent, 10)}%` }}>
          대출 {loanPercent.toFixed(0)}%
        </div>
        <div className="flex items-center justify-center bg-slate-300 text-xs font-bold text-slate-700" style={{ width: `${Math.max(selfPercent, 10)}%` }}>
        ...
        <ResultCard title="장기 상환 안정성">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-500">{stabilityInfo.totalYears}년 고정금리</span>
            </div>
