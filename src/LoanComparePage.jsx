...
function trackCtaClick({ ctaLabel, ctaLocation, destinationUrl }) {
  gtagSafe("event", "cta_click", { cta_label: ctaLabel, cta_location: ctaLocation, destination_url: destinationUrl });
}

function trackBridgeView() {
  gtagSafe("event", "bridge_view_compare", { event_category: "bridge" });
}
